...
const entries = [
  { key: 'company:name', value: 'Flowzint Interweave', type: 'fact', scope: 'customer_visible' },
  ...
  { key: 'rule:corrugator_capacity', value: 'We are starting a new corrugator. Currently we have 150 ton capacity of manufacturing available.', type: 'rule', scope: 'customer_visible' }
];

/**
 * Proforma Invoice HTML renderer — faithful to the Anjani Tax Invoice layout
 * (uploads/Anjani_Proforma_Invoice_Template.docx). Produces a self-contained,
...
<body><div class="doc border">
  ...
  <div class="head">
    ...
    <div class="badge">Division: PP WOVEN FABRIC</div>
  </div>
  ...
  <div class="watermark">Generated by Anjani AI Sales OS (Ravi) · PI ${esc(vm.piNumber)} · Order ${esc(vm.orderId)} · ${esc(vm.piDate)}</div>
</div></body></html>`;
}
